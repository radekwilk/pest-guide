...
document.querySelectorAll('.img-icon').forEach((el)=> {
   el.addEventListener('click',()=> {
    ...
    console.log(`Get the clicked button ID name: ${elID} and the  id text is: ${idName}`)
    ...
    // const newBackgroundImage = `${externalImagePath}-${IDNumber}.png)`; 
    ...
    // if(hoverImgStatus.buttons[IDNumber] === true) {
        ...
        //  hoverImage.style.backgroundImage = newBackgroundImage
            // hoverImage.style.backgroundImage = externalImage.imgPath
        
    // } else {
        // hoverImage.classList.remove('hover-img-js')
        // hoverImage.style.backgroundImage = defaultBackgroundImage
        // hoverImage.style.backgroundImage = externalImage.defaultImg
    // }
     
    if(idName == "info") {
        hoverStatus_toggleClass(IDNumber, externalImage.imgPath, externalImage.defaultImg )
        console.log(`Inside the FUNCTION, the IF statement, the  id text is: ${idName}`)

        console.log(`Inside the FUNCTION, the IF statement, the  ID number is : ${IDNumber}`)
        ...
        console.log(`Inside the FUNCTION, the ELSE statement, the  id text is: ${idName}`)
        console.log(`Inside the FUNCTION, the ELSE statement, the  ID number is : ${IDNumber}`)
...
const displayCheckPointSummary = (id, elName_issueDescription, elTitle, elText, elName, className) => {
    ...
    console.log(`Display the class element name: ${issueNumber}`)
